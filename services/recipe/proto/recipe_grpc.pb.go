...
func (c *recipeServiceClient) FindRecipeById(ctx context.Context, in *FindRecipeByIdRequest, opts ...grpc.CallOption) (*FindRecipeByIdResponse, error) {
	out := new(FindRecipeByIdResponse)
	err := c.cc.Invoke(ctx, "/recipe.RecipeService/FindRecipeById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *recipeServiceClient) ListRecipes(ctx context.Context, in *ListRecipesRequest, opts ...grpc.CallOption) (*ListRecipesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/recipe.RecipeService/ListRecipes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRecipeServiceServer) FindRecipeById(context.Context, *FindRecipeByIdRequest) (*FindRecipeByIdResponse, error) {
...
func _RecipeService_FindRecipeById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindRecipeByIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecipeServiceServer).FindRecipeById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/recipe.RecipeService/FindRecipeById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecipeServiceServer).FindRecipeById(ctx, req.(*FindRecipeByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RecipeService_ListRecipes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/recipe.RecipeService/ListRecipes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var RecipeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RecipeService_FindRecipeById_Handler,
		},
		{
	...
	Metadata: "services/recipe/proto/recipe.proto",
}
