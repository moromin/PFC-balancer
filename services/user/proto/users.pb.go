...
var file_proto_users_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x45, 0x0a, 0x11, 0x43, 0x72, 0x65,
	...
	0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x39, 0x0a, 0x17, 0x46, 0x69, 0x6e, 0x64, 0x55, 0x73,
	...
	0x61, 0x69, 0x6c, 0x12, 0x1c, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x55,
	0x73, 0x65, 0x72, 0x42, 0x79, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x1d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x55, 0x73, 0x65,
...
var file_proto_users_proto_goTypes = []interface{}{
	...
	(*FindUserByEmailRequest)(nil),  // 2: auth.FindUserByEmailRequest
	(*FindUserByEmailResponse)(nil), // 3: auth.FindUserByEmailResponse
	(*User)(nil),                    // 4: auth.User
}
var file_proto_users_proto_depIdxs = []int32{
	4, // 0: auth.CreateUserResponse.user:type_name -> auth.User
	4, // 1: auth.FindUserByEmailResponse.user:type_name -> auth.User
	0, // 2: auth.UserService.CreateUser:input_type -> auth.CreateUserRequest
	2, // 3: auth.UserService.FindUserByEmail:input_type -> auth.FindUserByEmailRequest
	1, // 4: auth.UserService.CreateUser:output_type -> auth.CreateUserResponse
	3, // 5: auth.UserService.FindUserByEmail:output_type -> auth.FindUserByEmailResponse
